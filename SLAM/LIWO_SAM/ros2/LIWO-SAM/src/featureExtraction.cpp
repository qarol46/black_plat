...
public:
    ...
    rclcpp::Subscription<liwo_sam::msg::CloudInfo>::SharedPtr subLaserCloudInfo;

    rclcpp::Publisher<liwo_sam::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    FeatureExtraction(const rclcpp::NodeOptions & options) :
        ParamServer("liwo_sam_featureExtraction", options)
    {
        subLaserCloudInfo = create_subscription<liwo_sam::msg::CloudInfo>(
            "liwo_sam/deskew/cloud_info", qos,
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<liwo_sam::msg::CloudInfo>(
            "liwo_sam/feature/cloud_info", qos);
        pubCornerPoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "liwo_sam/feature/cloud_corner", 1);
        pubSurfacePoints = create_publisher<sensor_msgs::msg::PointCloud2>(
            "liwo_sam/feature/cloud_surface", 1);
